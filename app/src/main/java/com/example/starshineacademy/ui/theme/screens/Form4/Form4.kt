package com.example.starshineacademy.ui.theme.screens.Form4
...
@Composable
fun Form4(navController: NavHostController){
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Row {
            ...
            Button(onClick = {
                navController.navigate(FORM4RECORDS_URL)
            },
