package com.example.starshineacademy.ui.theme.screens.Form1
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Card(modifier = Modifier.size(300.dp, height = 400.dp)) {
            Column(
                ...
                ImagePicker(modifier,context, navController, fullname.trim(),gender.trim(),kcpemarks.trim(),guardianname.trim(),guardianphonenumber.trim())
...
@Composable
fun ImagePicker(modifier: Modifier = Modifier, context: Context, navController: NavHostController, fullname:String,gender:String,kcpemarks:String,guardianname:String, guardianphonenumber:String,) {
